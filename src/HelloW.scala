...
object HelloW {
  ...
  def main(args: Array[String]) {
    val test = "max( tata ), min( mama ),char( wjek )"
    val test2 = "max( tata ), min( mama divide ),char( wjek )"
    val test3 = "tata <> 1, mama == '1', wjek <= 2.8"
    //val test = ""
...
//////////////////////////////////////////////////////////////////////
    ...
    eventsList2 = new ListBuffer[Event]()
    eventsList2 += event2
    evInt2 = new EventsInterval(eventsList2.toList, new Interval(1,collection.mutable.Map[String,String]("pradI" -> "72", "pradI_div" -> "300", "pradI_text" -> "ON")))
    seqInnerList2 += evInt2
...
//////////////////////////////////////////////////////////////////////
    ...
    eventsList3 = new ListBuffer[Event]()
    eventsList3 += event3
    event3 = new Event(3,7,collection.mutable.Map[String,String]("prad" -> "50", "prad_text" -> "Oahu4_2"))
    eventsList3 += event3
